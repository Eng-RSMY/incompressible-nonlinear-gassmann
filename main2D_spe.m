...
Kx=Perm(1:Grid.Nx,1:Grid.Ny,1,1);
Ky=Perm(1:Grid.Nx,1:Grid.Ny,1,2);
Kz=Perm(1:Grid.Nx,1:Grid.Ny,1,3);
%figure;surf(log10(reshape(Kx,Grid.Nx,Grid.Ny)));view(2);drawnow;
%figure;surf(log10(reshape(Ky,Grid.Nx,Grid.Ny)));view(2);drawnow;
%figure;surf(log10(reshape(Kz,Grid.Nx,Grid.Ny)));view(2);drawnow;
